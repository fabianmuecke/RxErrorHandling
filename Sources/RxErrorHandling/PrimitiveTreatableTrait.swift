...
public protocol PrimitiveTreatableTrait {}

extension TreatableSequenceType where Trait: PrimitiveTreatableTrait {
    /**
...
extension TreatableSequenceType where Element: RxAbstractInteger, Trait: PrimitiveTreatableTrait {
    /**
