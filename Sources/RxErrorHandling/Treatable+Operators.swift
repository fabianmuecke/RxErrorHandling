...
extension TreatableSequenceType where Element: TreatableSequenceType, Trait == TreatableTrait {
    /**
...
extension TreatableSequenceType where Element: Equatable, Trait == TreatableTrait {
    /**
...
extension TreatableSequenceType where Trait == TreatableTrait {
     ...
     */
    // sourcery: arityWithError = 8, trait = "TreatableTrait"
    ...
    /**
     ...
     - returns: An observable sequence containing the result of combining elements of the sources using the specified result selector function.
     */
    // sourcery: arity = 8, trait = "TreatableTrait"
    public static func zip<Collection: Swift.Collection, Result>(
        _ collection: Collection,
